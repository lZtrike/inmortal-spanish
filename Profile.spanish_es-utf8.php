...
$txt['gravatar_alternateEmail'] = 'Normalmente  el Gravatar usado será basado en tu dirección de email regular pero si tu deseas usar el Gravatar de un diferente email para tu cuenta del foro (Por ejemplo: El avatar de tu blog o de otra dirección de email) tu puedes entrar esa dirección de email aquí.';
$txt['gravatar_noAlternateEmail'] = 'El Gravatar mostrado será el basado en tu dirección de email.';
...
$txt['alert_prefs_desc'] = 'Esta página le permitirá configurar cuándo y cómo se le notificará sobre la existenciade un nuevo contenido.';
