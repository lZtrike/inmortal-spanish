<?php
// Version: Inmortal 1.0 Beta; ModerationCenter
...
$txt['mc_description'] = 'Este es tu &quot;Centro de Moderación&quot;. Desde aquí puedes realizar todas las acciones de moderación que te haya asignado el Administrador. Esta página principal contiene un resumen de todas lo que ha ocurrido recientemente en tu comunidad.';
...
$txt['mc_notes_delete_own'] = 'Solo estas permitido para borrar tus propias notas.';
...
$txt['mc_reportedp_comment_none_found'] = 'No se encuentra cometario de moderacion';
...
$txt['mc_reportedp_new_comment'] = 'Agregar un nuevo comentario';
...
$txt['mc_unapproved_attachments_desc'] = 'Desde aquí puedes aprobar o eliminar cualquier adjunto que esté esperando a ser moderado.';
...
$txt['mc_memberreport_whoreported_title'] = 'Miembros que han reportado a esta miembro.';
...
$txt['report_action_message_saved'] = 'Has creado sastisfacoriamente un nuevo comentario.';
$txt['report_action_message_edited'] = 'Has editado sastisfacoriamente el comentario.';
$txt['report_action_message_deleted'] = 'El mensaje fue correctamente borrado.';
$txt['report_action_message_edit_issue'] = 'El mensaje que tratas de editar no se encuentra disponible. Por favor chequea si no ha sido borrado.';
$txt['report_action_message_edit_cannot'] = 'Lo siento no tienes los permisos suficientes para editar este comentario.';
$txt['report_action_message_delete_cannot'] = 'Lo siento no tienes los permisos suficientes para borrar este comentario.';
$txt['report_action_message_delete_issue'] = 'El mensaje que tratas de borrar no se encuentra disponible. Por favor chequea si no ha sido borrado.';
...
$txt['report_action_close_all'] = 'Cerraste correctamente todos los informes seleccionados.';
$txt['report_action_open'] = 'El informe fue abierto correctamente.';
...
$txt['mc_warning_template_error_no_title'] = 'Debes establecer el título.';
$txt['mc_warning_template_error_no_body'] = 'Debes establecer un cuerpo para la notificación.';
...
$txt['mc_no_settings'] = 'No hay opciones que mostrar.';
